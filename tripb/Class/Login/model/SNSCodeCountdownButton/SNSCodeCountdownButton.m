...
//计时完成
- (void)noticeWithTextField{

    if ([self.delegate respondsToSelector:@selector(textfieldWithInteractive)]) {
        [self.delegate textfieldWithInteractive];
    }
